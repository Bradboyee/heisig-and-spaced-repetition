...
class SpacedFragment : Fragment() {
    ...
    private fun btn() {
        kanjiViewModel.arraySpacedKanji.observe(viewLifecycleOwner){
            data ->
            binding.floatingActionButton2.setOnClickListener {
                if (data.isEmpty()) {
                    ...
                    val action = SpacedFragmentDirections.actionSpacedFragmentToQuizFragment(data)
        ...
        kanjiViewModel.spacedKanji.observe(viewLifecycleOwner) { data ->
            ...
            binding.deleteDatabaseBtn.setOnClickListener {
                if (showData.isEmpty()) {
                    ...
                    Toast.makeText(this.requireContext(), showData.toString(), Toast.LENGTH_SHORT)
                        .show()
                }
            }
//            binding.floatingActionButton2.setOnClickListener {
...
//            }
    ...
    private fun getData() {
        ...
        kanjiViewModel.kanjiList.observe(this.viewLifecycleOwner) { items ->
            items.let { data ->
